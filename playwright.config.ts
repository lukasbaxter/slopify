...
export default defineConfig({
  ...
  webServer: {
    command: 'rm -rf /tmp/slopify-e2e-data && npm run build && SPEAKERS=0 MUSIC_DIR=fixtures/music DATA_DIR=/tmp/slopify-e2e-data PORT=8080 LOG_LEVEL=warn LOGIN_RATE_MAX=1000 node server/dist/index.js',
